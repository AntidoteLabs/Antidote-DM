...
ASSIGN_OPERATORS = [(op + '=', opfunc) for op, opfunc in OPERATORS]
ASSIGN_OPERATORS.append(('=', lambda cur, right: right))
...
class JSInterpreter(object):
    ...
    def interpret_expression(self, expr, local_vars, allow_recursion):
        ...
        if expr.startswith('('):
            ...
            for m in re.finditer(r'[()]', expr):
                ...
                raise TypeError('Premature end of parenthesis in %r' % expr)
    ...
    def extract_function(self, funcname):
        func_m = re.search(
            ...
            self.code)
        if func_m is None:
            raise TypeError('Could not find JS function %r' % funcname)
